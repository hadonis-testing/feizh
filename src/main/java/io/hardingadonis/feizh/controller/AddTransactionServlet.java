    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (type) {
            case INCOME: {
                ...
                Singleton.incomeTransactionDAO.insert(new IncomeTransaction(sourceWalletID, amount, description, type, categoryID));
            ...
            case EXPENSE: {
                ...
                Singleton.expenseTransactionDAO.insert(new ExpenseTransaction(sourceWalletID, amount, description, type, categoryID));
            ...
            case TRANSFER: {
                ...
                Singleton.transferTransactionDAO.insert(new TransferTransaction(sourceWalletID, amount, description, type, targetWalletID));
